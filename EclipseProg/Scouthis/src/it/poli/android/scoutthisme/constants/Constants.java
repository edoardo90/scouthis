...
public class Constants {
	...
	public static final String urlToUpdateFriends = "http://192.168.140.128/crud/update_fnd.php";
	public static final String UP_LIST_PARAM = "jfriendslist";
	public static final String UP_USERID_PARAM = "userid";
	
	public static final String urlToGetCoords = "http://192.168.140.128/crud/get_friends_coord.php";
