 ...
 */
public  class StepCounterHomeFragment extends Fragment implements ILegMovementListener, GpsListener
{
	...
	{
		View rootView = inflater.inflate(R.layout.fragment_section_stepcounter_home, container, false);
	...
	public void onResume()
	{
		...
		Button btnNewRun = (Button)this.getActivity().findViewById(R.id.btnNewRun);
		...
		btnHistory.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				FragmentTransaction transaction = getFragmentManager()
						...
						*/
						transaction.replace(R.id.stepcounter_frame, new StepCounterHistoryFragment());
						transaction.commit();
